...
public class FXMLDocumentFoldersAndAlbumsController implements Initializable {
    ...
    public void pasteFolder() throws IOException {
        if(clipboardFolder!=null)
    FileUtils.copyDirectoryToDirectory(clipboardFolder, selectedFolder);
        TreeItem<File> pastedTreeItem = new TreeItem<File>(clipboardFolder);
                selectedTreeItem.getChildren().add(pastedTreeItem);
